...
- ⚡ **Isolated Code Execution** — Run Python, Node.js, Go, and Bash in Sandflare.io microVMs
...
| Cache | Redis 7 |
| Execution | [Sandflare.io](https://sandflare.io) microVMs |
...
| `SANDFLARE_API_KEY` | Sandflare.io API key (use `mock-api-key` for local dev) |
...
The easiest way to deploy PandaFlow is via **[Pandastack.io](https://pandastack.io)** — the managed cloud platform by PandastackIO Inc. that runs PandaFlow with enterprise-grade isolation, automatic scaling, and a managed control plane backed by Sandflare microVMs.
